...
boxplot(ethereum_historical$Close, main = "Boxplot of Ethereum Closing Prices (2017-2024)", ylab = "Close Price")

# Identify potential outliers
outliers <- boxplot.stats(ethereum_historical$Close)$out
outliers
```
...
Who: This data is provided by a cryptocurrency exchange or financial data provider.
What: It includes historical Ethereum prices from 2017 to 2024.
When: The data covers daily Ethereum prices from January 1, 2017, to May 31, 2024.
Where: This data is sourced from online cryptocurrency exchanges or financial data services.
Why: The purpose of this data is to analyze long-term price trends of Ethereum.
How: The data was collected from the historical records of Ethereum transactions on various exchanges.

<Key Variables>

Date: Date of the recorded price (Type: Date)
Open: Opening price of Ethereum on the given date (Type: Numeric)
High: Highest price of Ethereum on the given date (Type: Numeric)
Low: Lowest price of Ethereum on the given date (Type: Numeric)
Close: Closing price of Ethereum on the given date (Type: Numeric)
Adj Close: Adjusted closing price of Ethereum, accounting for splits and dividends (Type: Numeric)
Volume: Number of Ethereum traded on the given date (Type: Numeric)

<Potential Outliers>
The price ranges around mid 40k were the outliers which they were All Time High prices were in 2021. 
...
What: It includes various economic indicators like PMI, Service PMI, and Consumer Confidence.
When: The data covers economic indicators from January 1, 2020, to May 31, 2024.
Where: This data is sourced from official reports, surveys, and financial data services.
Why: The purpose of this data is to analyze the impact of economic indicators on cryptocurrency prices.
How: The data was collected through surveys, reports, and financial data aggregation services.

<Key Variables>

date: Date of the recorded economic indicator (Type: Date)
manufacturing pmi: Purchasing Managers' Index for manufacturing (Type: Numeric)
services pmi: Purchasing Managers' Index for services (Type: Numeric)
consumer confidence: Consumer Confidence Index (Type: Numeric)

<Potential Outliers>
There were Service and Manufacturing PMI had several outliers, but not seen in consumer confidence.
